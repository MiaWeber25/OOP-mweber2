...
class TestDataSet(unittest.TestCase):
    ...
    def test_init(self, lst: List[int]) -> None:
        """ Test initialization. """
        data_set = DataSet(lst)
        self.assertEqual(list(data_set), lst)

    @given(st.integers(min_value=1))
    def test_case_number(self, case_num: int) -> None:
    ...
    def test_case_number_validation(self, case_num: int) -> None:
    ...
    def test_get_min(self, lst: List[int]) -> None:
        """ Test get_min() """
        data_set = DataSet(lst)
        self.assertEqual(data_set.get_min(), min(lst))

    @given(st.lists(st.integers(), min_size=1))
    def test_get_max(self, lst: List[int]) -> None:
        """ Test get_max() """
        data_set = DataSet(lst)
        self.assertEqual(data_set.get_max(), max(lst))

    @given(st.lists(st.integers(), min_size=1))
    def test_get_range(self, lst: List[int]) -> None:
        """ Test get_range() """
        data_set = DataSet(lst)
